...
public class CatalogService {
    ...
    public List<EducationLevel> activeLevels() {
        return levels.findByActiveTrueOrderBySortOrderAscNameAsc();
    }
    ...
    public CreationResult createCourses(List<Long> levelIds, Integer number, String name, boolean active) {
        ...
        for (EducationLevel level : selected) {
            ...
            course.setEducationLevel(level);
    ...
    private String checkedName(String name, int maxLength) {
        ...
        if (trimmed.length() > maxLength)
            throw new IllegalArgumentException("Название не должно превышать " + maxLength + " символов");
        return trimmed;
    }
