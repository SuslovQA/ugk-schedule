...
public class UserPreference {
    ...
    @ManyToOne(fetch = FetchType.EAGER) @JoinColumn(name = "education_level_id")
    ...
    public MessengerType getMessenger() { return messenger; }
    public void setMessenger(MessengerType messenger) { this.messenger = messenger; }
